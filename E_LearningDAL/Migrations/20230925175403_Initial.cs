    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Certificates", x => new { x.CertificateId, x.StudentId, x.CourseId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Enrollments", x => new { x.EnrollmentId, x.StudentId, x.CourseId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Quizes", x => new { x.QuizId, x.CourseId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentsQuizes", x => new { x.StudentId, x.QuizId });
                    table.ForeignKey(
                        name: "FK_StudentsQuizes_Quizes_QuizId1_QuizCourseId",
                        columns: x => new { x.QuizId1, x.QuizCourseId },
                        principalTable: "Quizes",
                        principalColumns: new[] { "QuizId", "CourseId" },
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StudentsQuizes_Students_StudentId",
                        column: x => x.StudentId,
                        principalTable: "Students",
                        principalColumn: "StudentId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentsQuizes_QuizId1_QuizCourseId",
                table: "StudentsQuizes",
                columns: new[] { "QuizId1", "QuizCourseId" });
        }
